...
import { light, dark, components, global, large, small } from 'hpe-design-tokens';
...
var primaryBackground = function primaryBackground(props) {
  return !props.active ? "background: " + components.hpe.button.primary.enabled.background + "; background-color: " + props.theme.global.colors[components.hpe.button.primary.enabled.backgroundColor][props.theme.dark ? 'dark' : 'light'] + ";" : '';
};
...
var primaryHoverBackground = function primaryHoverBackground(props) {
  return !props.active ? "background-color: " + components.hpe.button.primary.hover.background + ";" : "color: " + props.theme.global.colors[components.hpe.button.primary.selected.enabled.textColor][props.theme.dark ? 'dark' : 'light'];
};
var dimensions = {
  borderSize: {
...
export var hpe = deepFreeze({
  ...
  button: {
    ...
    primary: {
      background: '',
      border: {
        width: dimensions.borderSize[components.hpe.button.medium.primary.borderWidth] || components.hpe.button.medium.primary.borderWidth,
    ...
    secondary: {
      ...
      border: {
        width: dimensions.borderSize[components.hpe.button.medium.secondary.borderWidth] || components.hpe.button.medium.secondary.borderWidth,
    ...
    toolbar: {
      border: {
        width: dimensions.borderSize[components.hpe.button.medium.toolbar.borderWidth] || components.hpe.button.medium.toolbar.borderWidth,
        color: components.hpe.button.toolbar.enabled.borderColor,
        radius: dimensions.borderSize[components.hpe.button.medium.toolbar.borderRadius] || components.hpe.button.medium.toolbar.borderRadius
      },
    ...
    extend: function extend(_ref2) {
      ...
      var fontSize = (_components$hpe$butto = components.hpe.button) == null || (_components$hpe$butto = _components$hpe$butto[sizeProp]) == null || (_components$hpe$butto = _components$hpe$butto[kind]) == null ? void 0 : _components$hpe$butto.fontSize;
      var lineHeight = (_components$hpe$butto2 = components.hpe.button) == null || (_components$hpe$butto2 = _components$hpe$butto2[sizeProp]) == null || (_components$hpe$butto2 = _components$hpe$butto2[kind]) == null ? void 0 : _components$hpe$butto2.lineHeight;
      var style = '';
      ...
      if (kind === 'secondary') {
        ...
        style += "&:hover { box-shadow: " + ((_components$hpe$butto3 = components.hpe.button[sizeProp].secondary) == null || (_components$hpe$butto3 = _components$hpe$butto3.hover) == null ? void 0 : _components$hpe$butto3.boxShadow) + "; }";
      }
      return style;
    }
  },
  ...
  checkBox: {
    ...
    check: {
      ...
      extend: function extend(_ref5) {
        ...
        return "\n      margin-block: " + (parseFloat(large.hpe.text.medium.lineHeight, 10) * 16 - parseFloat(components.hpe.checkbox.medium.control.height, 10) * 16) / 2 + "px;\n      background-color: " + (checked || indeterminate ? (_theme$global$colors$3 = theme.global.colors[components.hpe.checkbox.control.selected.enabled.background]) == null ? void 0 : _theme$global$colors$3[theme.dark ? 'dark' : 'light'] : theme.global.colors.background[theme.dark ? 'dark' : 'light']) + ";\n      " + ((checked || indeterminate) && 'border: none;') + "\n        ";
      }
    },
    icon: {
      extend: function extend(_ref6) {
        ...
        return "stroke-width: 2px;\n      stroke: " + ((_theme$global$colors$4 = theme.global.colors[components.hpe.checkbox.control.selected.enabled.iconColor]) == null ? void 0 : _theme$global$colors$4[theme.dark ? 'dark' : 'light']);
      }
    },
    ...
    toggle: {
      ...
      extend: function extend(_ref8) {
        ...
        var checked = _ref8.checked,
          theme = _ref8.theme;
        return "\n        " + (checked && "background-color: " + ((_theme$global$colors$5 = theme.global.colors[components.hpe["switch"].control.track.selected.enabled.background]) == null ? void 0 : _theme$global$colors$5[theme.dark ? 'dark' : 'light']) + ";") + "\n      ";
      }
    },
    // HPE Design System guidance states that pad="none" should be applied on CheckBox
    // when its used outside of a FormField. We will apply this hover treatment in
  ...
  dataTable: {
    ...
    icons: {
      ascending: function ascending() {
        return /*#__PURE__*/React.createElement(Ascending, null);
      },
      descending: function descending() {
        return /*#__PURE__*/React.createElement(Descending, null);
      },
      ...
      sortable: function sortable() {
        return /*#__PURE__*/React.createElement(Unsorted, null);
      }
    },
    pinned: {
      header: {
  ...
  text: {
    ...
    extend: function extend(_ref17) {
      ...
      return "\n      " + (['xxlarge', '3xl', '4xl', '5xl', '6xl'].includes(size) ? "font-weight: " + large.hpe.text[size].fontWeight + ";" : '') + ";\n    ";
    }
  },
  textInput: {
    container: {
