    ...
    checkBox: {
      hover: {
        ...
        extend: function extend(_ref) {
          ...
          var borderColor = toggle ? getThemeColor(components.hpe["switch"]["default"].control.track.selected.hover.borderColor, theme) : getThemeColor(components.hpe.checkbox["default"].control.selected.hover.borderColor, theme);
