...
var _prism = require("../../themes/prism");
...
describe('prism builder', function () {
  ...
  it('builds the canonical prism theme from tokens', function () {
    expect((0, _prism.buildPrism)(tokens)).toEqual(_prism.prism);
  });
  it('responds to token changes instead of using a precomputed import', function () {
    ...
    expect((0, _prism.buildPrism)(customTokens).light['code[class*="language-"]'].color).toBe('#123456');
    expect((0, _prism.buildPrism)(customTokens).light['pre[class*="language-"]'].background).toBe((0, _colors.buildColors)(customTokens)['background-contrast'].light);
  });
});