    ...
    color: {
      background: {
        ...
        'accent-purple-strong':
          'var(--hpe-color-background-accent-purple-strong)',
        ...
        'neutral-xstrong-hover':
          'var(--hpe-color-background-neutral-xstrong-hover)',
        ok: 'var(--hpe-color-background-ok)',
        'primary-strong': 'var(--hpe-color-background-primary-strong)',
        'primary-strong-hover':
          'var(--hpe-color-background-primary-strong-hover)',
        ...
        'selected-primary-hover':
          'var(--hpe-color-background-selected-primary-hover)',
        'selected-primary-strong':
          'var(--hpe-color-background-selected-primary-strong)',
        'selected-primary-strong-hover':
          'var(--hpe-color-background-selected-primary-strong-hover)',
      ...
      icon: {
        ...
        onSelectedPrimaryStrong:
          'var(--hpe-color-icon-onSelectedPrimaryStrong)',
      ...
      text: {
        ...
        onSelectedPrimaryStrong:
          'var(--hpe-color-text-onSelectedPrimaryStrong)',
