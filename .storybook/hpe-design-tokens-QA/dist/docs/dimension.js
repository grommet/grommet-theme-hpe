...
export default {
  'hpe.borderWidth.default': {
    $description:
      'Default border-width for standard uses like border as visual separator.',
    $extensions: {
      'com.figma': {
        codeSyntax: {},
  ...
  'hpe.borderWidth.xsmall': {
    ...
    path: ['borderWidth', 'xsmall'],
    key: '{borderWidth.xsmall}',
  },
  'hpe.container.3xlarge': {
    $description:
      'Use to define the minimum/maximum width and height of containers or layout elements. For example, box, card and grids.',
    $extensions: {
      'com.figma': {
        codeSyntax: {},
        hiddenFromPublishing: false,
  ...
  'hpe.heading.medium.fontWeight': {
    ...
    path: ['heading', 'medium', 'fontWeight'],
  ...
  'hpe.heading.medium.lineHeight': {
    ...
    path: ['heading', 'medium', 'lineHeight'],
  ...
  'hpe.heading.xlarge.fontWeight': {
    ...
    path: ['heading', 'xlarge', 'fontWeight'],
  ...
  'hpe.heading.xlarge.lineHeight': {
    ...
    path: ['heading', 'xlarge', 'lineHeight'],
  ...
  'hpe.heading.xsmall.fontWeight': {
    ...
    path: ['heading', 'xsmall', 'fontWeight'],
  ...
  'hpe.heading.xsmall.lineHeight': {
    ...
    path: ['heading', 'xsmall', 'lineHeight'],
  ...
  'hpe.heading.xxsmall.fontWeight': {
    ...
    path: ['heading', 'xxsmall', 'fontWeight'],
  ...
  'hpe.heading.xxsmall.lineHeight': {
    ...
    path: ['heading', 'xxsmall', 'lineHeight'],
  ...
  'hpe.text.3xlarge.lineHeight': {
    ...
    path: ['text', '3xlarge', 'lineHeight'],
    key: '{text.3xlarge.lineHeight}',
  },
  'hpe.text.3xlarge.maxWidth': {
    $description:
      'For use with paragraph max-width to enhance readability based on WCAG 80 character per line recommendation.',
    $extensions: {
      'com.figma': {
        codeSyntax: {},
        hiddenFromPublishing: false,
