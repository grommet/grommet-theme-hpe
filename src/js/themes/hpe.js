...
const buildTheme = (tokens, flags) => {
  ...
  return deepFreeze({
    ...
    maskedInput: miscTheme.maskedInput,
    ...
    starRating: miscTheme.starRating,
    ...
    textInput: miscTheme.textInput,
    tip: feedbackTheme.tip,
    thumbsRating: miscTheme.thumbsRating,
    toggleGroup: miscTheme.toggleGroup,
    toolbar: miscTheme.toolbar,
